...
const CATS = {
  "chairs": {
    title: "Restaurant Chairs", h1: "Restaurant & Café Chairs",
    match: p => /chair/i.test(p.cat||'') && !/outdoor/i.test(p.cat||'') && p.section!=='residential',
    intro: "Commercial-grade dining chairs for restaurants, cafés and bars — metal, PVC, wooden, cushioned and cane designs, all in ready stock for 2–7 day delivery across Hyderabad, Bangalore and pan-India.",
    body: "Gharnish stocks 150+ chair designs built for hospitality use: heavy-duty frames, commercial upholstery and finishes that survive daily service. From budget PVC stackables for QSRs to teak-and-cane statement chairs for fine-dine, every design ships from ready stock so you furnish in days, not months.",
  ...
  "tables": {
    title: "Restaurant Tables & Bases", h1: "Restaurant Tables & Table Bases",
    match: p => /table/i.test(p.cat||'') && p.section!=='residential',
    intro: "Café and restaurant tables with ply-laminate, sintered-stone, marble, terrazzo and Corian tops on cast-iron and MS bases. 25+ varieties in ready stock, delivered across Hyderabad, Bangalore and India in days.",
    body: "Choose your top material and base independently: 18mm ply-laminate tops in 100s of finishes, or premium sintered-stone and marble for fine-dine. Bases range from single-pillar cast iron to double-pillar and 4-leg MS frames — all commercial-weighted for stability under heavy use. Standard café sizes (2×2, 4×2, round) and fine-dine sizes (2.5×2.5, 4×2.5, 6×2.5) available.",
    faqs: [["What table top material is best for a restaurant?", "Ply-laminate is the most popular for cafés — durable, low-maintenance and available in 100s of finishes. For premium fine-dine, sintered stone and marble offer a luxury look with high heat and scratch resistance."], ["What size table do I need for 2 or 4 seaters?", "Cafés typically use 2×2 ft for 2-seaters and 3 ft round or 3×3 ft for 4-seaters. Fine-dine setups use larger 4×2.5 ft or 6×2.5 ft tables. We'll help you size to your covers."], ["Can I mix and match tops and bases?", "Yes. Gharnish table tops and bases are sold to be paired freely, so you can match any top material to any base style for your venue."], ["How fast can restaurant tables be delivered in Bangalore?", "In-stock tables deliver in 2–7 days across Bangalore and pan-India, with free installation."]]
  },
  "stools": {
    title: "Bar Stools", h1: "Bar & Counter Stools",
    match: p => /stool/i.test(p.cat||''),
  ...
  "booth": {
    title: "Booth & Sofa Seating", h1: "Booth & Sofa Seating",
    match: p => /booth|sofa/i.test(p.cat||'') && p.section!=='residential',
  ...
  "outdoor": {
    title: "Outdoor Furniture", h1: "Outdoor & Patio Furniture",
    match: p => /outdoor/i.test(p.cat||''),
    intro: "Weather-resistant outdoor furniture for café patios, rooftops and garden dining — rope, PVC and WPC chairs with stone, WPC and glass tables. Ready stock across Hyderabad and Bangalore.",
    body: "Gharnish outdoor furniture uses weather-resistant materials — rope weave, PVC and WPC — that hold up to sun and rain for rooftop cafés, garden restaurants and patio seating. Paired with stone and WPC table tops built for the outdoors.",
    faqs: [["Is outdoor furniture weatherproof?", "Yes — our outdoor range uses rope, PVC and WPC materials chosen for sun and rain resistance, suitable for uncovered patios and rooftops."], ["Do you have outdoor tables to match?", "Yes — stone, WPC and glass outdoor tables pair with our outdoor seating."], ["Can outdoor furniture be delivered pan-India?", "Yes, in-stock outdoor furniture ships in 2–7 days across India."]]
  },
};
...
function renderResidential(products, origin){
  const items = products.filter(p=>p.section==="residential");
